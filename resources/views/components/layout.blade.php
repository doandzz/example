    ...
    <nav class="bg-gray-800">
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            -->
                ...
                <div class="flex flex-1 items-center justify-center sm:item s-stretch sm:justify-start">
                        ...
                        <div>
                            <button type="button"
                                ...
                                <img class="size-8 rounded-full"
                                    src="https://cdn.pixabay.com/photo/2023/02/08/02/40/iron-man-7775599_1280.jpg"
                                    alt="">
                            </button>
                        </div>
